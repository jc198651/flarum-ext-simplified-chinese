moment.locale('zh', {
  ...
  calendar: {
    sameDay: function () {
      return this.minutes() === 0 ? '[今天] h [点整]' : '[今天] LT';
    },
    nextDay: function () {
      return this.minutes() === 0 ? '[明天] h [点整]' : '[明天] LT';
    },
    lastDay: function () {
      return this.minutes() === 0 ? '[昨天] h [点整]' : '[昨天] LT';
    },
    nextWeek: function () {
      var startOfWeek, prefix;
      startOfWeek = moment().startOf('week');
      prefix = this.unix() - startOfWeek.unix() >= 7 * 24 * 3600 ? '[下]' : '[本]';
      return this.minutes() === 0 ? prefix + 'ddd h 点整' : prefix + 'ddd h 点 mm';
    },
    lastWeek: function () {
      var startOfWeek, prefix;
      startOfWeek = moment().startOf('week');
